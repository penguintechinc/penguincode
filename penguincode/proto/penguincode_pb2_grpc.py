...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in penguincode_pb2_grpc.py depends on'
...
class ToolCallbackServiceStub(object):
...
class ToolCallbackServiceServicer(object):
    """Tool Callback Service - Bidirectional streaming
    """
...
def add_ToolCallbackServiceServicer_to_server(servicer, server):
 ...
 # This class is part of an EXPERIMENTAL API.
class ToolCallbackService(object):
    """Tool Callback Service - Bidirectional streaming
    """
